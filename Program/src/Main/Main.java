     ...
     private static void gotoMenu(int in){
        ...
        switch(in){
            case 1: System.out.println("--------------------------------------------------");
                    ...
                    if(genK.genKey(filename,size))System.out.println("[Generate Key complete!!]");
                    System.out.println("--------------------------------------------------");
                    break;
            case 2: System.out.println("--------------------------------------------------");
                    ...
                    if(encrypt.encrypt(filename, size))System.out.println("[Dencryption Complete!!]");
                    System.out.println("--------------------------------------------------");
                    break;
            case 3: System.out.println("--------------------------------------------------");
                    ...
                    if(decryp.Decrypt(size))System.out.println("[Decryption Complete!!]");
                    System.out.println("--------------------------------------------------");
                    break;
