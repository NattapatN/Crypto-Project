...
//        cipherB = f2b.toBit("CipherB.txt").toString();
        ...
        try {
            ...
            BufferedReader brA =new BufferedReader(new FileReader("CipherA.txt"));
            BufferedReader brB =new BufferedReader(new FileReader("CipherB.txt"));
            
            cipherA = brA.readLine();
            cipherB = brB.readLine();
